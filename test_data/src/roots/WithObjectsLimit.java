...
public class WithObjectsLimit extends TestBase {
    public static void main(String[] args) {
        ...
        doPrintGcRoots(IdeaNativeAgentProxy.findPathsToClosestGcRoots(root1.getLast(), 5, 10));
        TestNode root2 = new TestNode(5000, root1.getLast());
        TestNode root3 = new TestNode(1000, root1.getLast());
        doPrintGcRoots(IdeaNativeAgentProxy.findPathsToClosestGcRoots(root1.getLast(), 5, 10));
        doPrintGcRoots(IdeaNativeAgentProxy.findPathsToClosestGcRoots(root1.getLast(), 5, 20));
    }
}
