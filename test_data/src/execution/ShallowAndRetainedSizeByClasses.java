...
public class ShallowAndRetainedSizeByClasses extends ExecutionTestBase {
    @Override
    protected MemoryAgentErrorCode executeOperation(IdeaNativeAgentProxy proxy) {
        ...
        return getErrorCode(proxy.getShallowAndRetainedSizeByClasses(new Object[] {TestTreeNode.Impl2.class}));
    }

    public static void main(String[] args) {
        ExecutionTestBase test = new ShallowAndRetainedSizeByClasses();
        test.doTest();
    }
}
